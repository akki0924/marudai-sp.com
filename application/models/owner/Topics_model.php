...
print "_2_";
    ...
    */
    public function InputTemplate ()
    {
        ...
        {
            // 登録データがあるかどうか
            if ( $this->topics_lib->IdExists ( $resultVal['place_id'], true ) )
            {
                // 登録データを取得
                $regData = $this->topics_lib->DetalVal ( $resultVal['place_id'], true );
                // 登録情報をセット
    ...
    */
    public function EditAction ()
    {
        ...
        // 更新処理
        $place_id = $this->topics_lib->Regist ( $place_id, $formVal );
    ...
    */
    public function DelAction ()
    {
       ...
       // 返値を初期値
        ...
        $returnVal['list'] = $this->load->view( Login_model::AUTH_OWNER . '/topics_list_part', $listVal, true);
