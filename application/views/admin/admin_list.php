...
$(function() {
	$('.edit_btn').click(function() {
		...
		$('#operation_form').attr( 'action', '<?= SiteDir(); ?>admin/admin/input' );
...
<main>
	...
	<section id="management">
		...
		<div class="container">
		<form method="post" id="operation_form" name="operation_form" action="<?= SiteDir(); ?>admin/admin">
			<h2 class="mb_40">ログイン管理</h2>
			<div class="scroll">
