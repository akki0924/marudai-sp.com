		...
		<div class="container">
			...
			<div class="max680">
				<div class="bg_gray pd60">
					<p class="font_20 bold mb_10"><?= $exists ? 'ログイン情報更新' : '新規ログイン登録' ?>完了</p>
					<p class="mb_40"><?= $exists ? 'ログイン情報の更新' : '新規ログイン登録' ?>が完了しました。</p>
					<center><a href="<?= SiteDir(); ?>admin/admin" class="btn short">ログイン管理へ戻る</a></center>
				</div><!--./bg_gray-->
			</div><!--./max680-->
		</div><!--./container-->
	</section>
