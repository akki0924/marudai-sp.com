	...
	<section id="management">
		<div class="container">
			<div class="row">
				...
				<div class="col5"><a href="<?= SiteDir(); ?><?= $const['access_admin_dir'] ?>/sheet2" class="btn mng frame">チェックシート2管理</a></div>
			...
			<div class="max680">
				<div class="bg_gray pd60 mb_40">
					<form method="post" id="operation_form" name="operation_form" action="<?= SiteDir(); ?><?= $const['access_admin_dir'] ?>/sheet2/input" class="h-adr">
						...
						<a href="<?= SiteDir(); ?><?= $const['access_admin_dir'] ?>/sheet2" class="btn frame">キャンセル</a>
