...
<head>
  ...
  <script type="text/javascript" src="<?= site_dir(); ?>js/admin/datepicker-ja.js"></script>
</head>
<body>
...
<div class="card-body">
	...
	<div class="col-6 cont_center">
		完了しました
		<button type="submit" class="cont_center btn btn-block btn-default col-3 mb-2" onClick="location.href='<?=site_dir();?>admin/genre'">一覧に戻る</button>
	</div>
