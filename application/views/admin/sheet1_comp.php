		...
		<div class="container">
			...
			<div class="max680">
				<div class="bg_gray pd60">
					<p class="font_20 bold mb_10"><?= $exists ? 'チェックシート1情報更新' : '新規チェックシート1登録' ?>完了</p>
					<p class="mb_40"><?= $exists ? 'チェックシート1情報の更新' : '新規チェックシート1登録' ?>が完了しました。</p>
					<center><a href="<?= SiteDir(); ?><?= $const['access_admin_dir'] ?>/sheet1" class="btn short">チェックシート1管理へ戻る</a></center>
				</div><!--./bg_gray-->
			</div><!--./max680-->
		</div><!--./container-->
	</section>
