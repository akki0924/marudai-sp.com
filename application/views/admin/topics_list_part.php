    ...
    <tbody>
        <tr>
            ...
            <td width="22%">
                ...
                <?= form_radio( "status" . $list[$i]['id'], $status_key, ( isset ( $list[$i]['status'] ) && $list[$i]['status'] == $status_key ? true : false ), "id=status" . $list[$i]['id'] . "_" . $status_key . " class='topics_status' data-id='" . $list[$i]['id'] . "'" ); ?>
