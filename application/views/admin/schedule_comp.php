...
<head>
  ...
  <title>スケジュール情報｜Nagoya art news</title>
...
<div class="card-header"><p class="card-title">スケジュール情報</p></div>
<div class="card-body">
	<div class="col-8 cont_center"><p class="card-title mb-4 text-center">スケジュール情報編集</p></div>
	
	<div class="col-6 cont_center">
		完了しました
		<button type="submit" class="cont_center btn btn-block btn-default col-3 mb-2" onClick="location.href='<?=site_dir();?>admin/schedule'">一覧に戻る</button>
	</div>
