	...
	<section id="management">
		<div class="container">
			<div class="row mb_80">
				...
				<div class="col3"><a href="<?= SiteDir(); ?>admin/sheet1" class="btn mng">チェックシート1管理</a></div>
				<div class="col3"><a href="<?= SiteDir(); ?>admin/sheet2" class="btn mng frame">チェックシート2管理</a></div>
			</div>
		</div><!--/.container-->

		<div class="container">
		<form method="post" id="operation_form" name="operation_form" action="<?= SiteDir(); ?>admin/sheet2">
