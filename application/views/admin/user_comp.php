	...
	<section id="management">
		<div class="container">
			<div class="row">
				...
				<div class="col5"><a href="<?= SiteDir(); ?><?= $const['access_admin_dir'] ?>/user" class="btn mng frame">登録者管理</a></div>
			</div>
		</div><!--./container-->
	</section>
		...
		<div class="container">
			...
			<div class="max680">
				<div class="bg_gray pd60">
					<p class="font_20 bold mb_10"><?= $exists ? '登録者情報更新' : '新規登録者登録' ?>完了</p>
					<p class="mb_40"><?= $exists ? '登録者情報の更新' : '新規登録者登録' ?>が完了しました。</p>
					<center><a href="<?= SiteDir(); ?><?= $const['access_admin_dir'] ?>/user" class="btn short">登録者管理へ戻る</a></center>
				</div><!--./bg_gray-->
			</div><!--./max680-->
		</div><!--./container-->
	</section>
